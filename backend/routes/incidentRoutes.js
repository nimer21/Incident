...
const { reportIncident, getIncidents, getIncidentById, updateIncidentSeverity, addCommentsIncident, fileUploadIncident, getIncidentsByRole } = require('../controllers/incidentController');
...
router.post("/upload",upload.single("file"),authenticateToken(["super_admin","user", "data_breach"]), fileUploadIncident);
